...
public class ObjectUIBehavior : MonoBehaviour
{
    ...
    private void _pickedUpdate()
    {
        ...
        this._accelate = (this._position - prev) * 20.0f;
        this._accelate.z = Random.Range(20.0f, 30.0f);
    }
    ...
    public void Released()
    {
        ...
        this._updatelists = new UpdateList(this._releasedUpdate);
    ...
    private void _releasedUpdate()
    {
        ...
        this._velocity += -this._velocity * Time.deltaTime * 10.0f;
    ...
    private void _throwedUpdate()
    {
        ...
        if (Vector3.Distance(Camera.main.transform.localPosition, this._position) > 20.0)
        {
            this.Released();
        }
    }
